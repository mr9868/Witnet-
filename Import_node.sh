...
totalCont=${#listCont[@]};
                                                                                                                                                        #install witnet                                                                                                                                         function witnetInstall(){                                                                                                                                  docker run --name witnet${totalCont}_node --runtime runc \                                                                                              -v /root/.witnet:/witnet \                                                                                                                              -v /root/.witnet/config/privKey${totalCont}.txt:/witnet/privKey.txt \                                                                                   -p $(( 21337 + ${totalCont} )):$(( 21337 + ${totalCont} ))/tcp \
   ...
   '--master-key-import' '/witnet/privKey.txt'
}
witnetInstall
